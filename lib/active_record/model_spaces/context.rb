  ...
  module ModelSpaces
    ...
    class Context
      ...
      def table_name(model)
        ...
        TableNames.table_name(model, model_space.name, model_space_key, model_space.history_versions(model), version)
      end
      ...
      def current_table_name(model)
        TableNames.table_name(model, model_space.name, model_space_key, model_space.history_versions(model), current_model_versions[model])
      end
      ...
      def next_table_name(model)
        ...
        TableNames.table_name(model, model_space.name, model_space_key, model_space.history_versions(model), next_version)
      end
      ...
      def working_table_name(model)
        TableNames.table_name(model, model_space.name, model_space_key, model_space.history_versions(model), working_model_versions[model]) if working_model_versions[model]
      end
